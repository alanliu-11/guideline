# Claude Skill: Refactoring Guidelines

## Purpose
This skill provides guidelines for when and how to refactor code. Use this when improving code structure without changing behavior.
...
1. **Only refactor on green** - Tests must pass first
2. **Commit after each refactor** - Create safety checkpoints
3. **Never mix refactoring with features** - One at a time
4. **Small steps** - Make one change, test, commit, repeat
5. **Trust tests** - They catch mistakes immediately
