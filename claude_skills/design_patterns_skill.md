...
## Purpose
This skill provides guidance on when and how to use design patterns. Patterns are tools, not rules—use them when they solve a real problem.

## Before Applying Patterns

**Important:** When using patterns involving multiple classes, always confirm with the user before applying the pattern.
...
5. Document your decision in architectural decisions

## Key Takeaways

1. **Patterns are tools** - Use them to solve problems, not for their own sake
2. **Confirm before applying** - Especially for multi-class patterns
3. **Start simple** - Add patterns when complexity demands them
4. **Favor common patterns** - Dependency Injection, Repository, Factory Method
5. **Avoid anti-patterns** - God Objects, Premature Abstraction, Pattern Obsession
